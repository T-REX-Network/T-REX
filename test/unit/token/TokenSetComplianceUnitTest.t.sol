...
contract TokenSetComplianceUnitTest is TokenBaseUnitTest {
    ...
    function setUp() public override {
        ...
        accessManager.grantRole(RolesLib.role(RolesLib.SHARED, RolesLib.IDENTITY_MANAGER), address(this), 0);
    ...
    function testTokenSetComplianceRevertsWhenCallerOnlyTokenAdmin() public {
        ...
        accessManager.grantRole(RolesLib.role(RolesLib.SHARED, RolesLib.TOKEN_MANAGER), tokenAdmin, 0);
