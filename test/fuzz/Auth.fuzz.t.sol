...
contract AuthFuzzTest is TREXSuiteTest {
    ...
    function testFuzz_mintUnauthorized(address caller, address to, uint256 amount) public {
        _assumeNoRole(caller, RolesLib.role(RolesLib.SHARED, RolesLib.AGENT_MINTER));
        vm.prank(caller);
    ...
    function testFuzz_burnUnauthorized(address caller, address from, uint256 amount) public {
        _assumeNoRole(caller, RolesLib.role(RolesLib.SHARED, RolesLib.AGENT_BURNER));
        vm.prank(caller);
        vm.expectRevert(abi.encodeWithSelector(IAccessManaged.AccessManagedUnauthorized.selector, caller));
    ...
    function testFuzz_forcedTransferUnauthorized(address caller, address from, address to, uint256 amount) public {
        _assumeNoRole(caller, RolesLib.role(RolesLib.SHARED, RolesLib.AGENT_FORCED_TRANSFER));
        vm.prank(caller);
        vm.expectRevert(abi.encodeWithSelector(IAccessManaged.AccessManagedUnauthorized.selector, caller));
    ...
    function testFuzz_pauseUnauthorized(address caller) public {
        _assumeNoRole(caller, RolesLib.role(RolesLib.SHARED, RolesLib.AGENT_PAUSER));
        vm.prank(caller);
        vm.expectRevert(abi.encodeWithSelector(IAccessManaged.AccessManagedUnauthorized.selector, caller));
        token.pause();
    }
    ...
    function testFuzz_freezePartialUnauthorized(address caller, address user, uint256 amount) public {
        _assumeNoRole(caller, RolesLib.role(RolesLib.SHARED, RolesLib.AGENT_PARTIAL_FREEZER));
        vm.prank(caller);
        vm.expectRevert(abi.encodeWithSelector(IAccessManaged.AccessManagedUnauthorized.selector, caller));
    ...
    function testFuzz_setNameUnauthorized(address caller, string calldata newName) public {
        _assumeNoRole(caller, RolesLib.role(RolesLib.SHARED, RolesLib.TOKEN_MANAGER));
        vm.prank(caller);
        vm.expectRevert(abi.encodeWithSelector(IAccessManaged.AccessManagedUnauthorized.selector, caller));
