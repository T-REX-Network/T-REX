    ...
    AccessManagedOwnableUpgradeable
{
    ...
    /// @inheritdoc ITransferValidation
    function refundValidation(uint256 validationId) external restricted {
        _refundValidation(validationId);
    }
    ...
    /// @inheritdoc TransferValidation
    function _returnOnToken(bytes memory to, uint256 validationId) internal override {
        _boundToken().returnInTransit(to, validationId);
    }
