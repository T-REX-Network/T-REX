...
//
// Vendored from OpenZeppelin Contracts master at commit 36f867827b
// (PR https://github.com/OpenZeppelin/openzeppelin-contracts/pull/6402, 2026-05-13).
// As of OZ v5.6.1 (the version currently pinned in foundry.toml) this library has
// not yet shipped in a tagged release. This file is unmodified except for the
// import paths (rewritten to this project's OZ remapping) and this header.
// Remove this vendored copy and import @openzeppelin/contracts/utils/Create3.sol
// directly once a tagged OZ release ships the Create3 library.
